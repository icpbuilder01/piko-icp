...
// to be open -- see ../../../piko-icp/frontend/src/lib/auth.ts's own
// comment for the full story (a real user-reported bug on the mining site,
// same root cause, same fix, applied here too). Skipped for local dev,
// where the canonical mainnet origin isn't relevant.
const CANONICAL_ORIGIN = "https://77zu2-baaaa-aaaaj-qseiq-cai.icp.net";
