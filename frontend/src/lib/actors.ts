...
// it's a fixed id rather than something read from canister-env. ICP wallet
// features only work when this site itself is served from mainnet (a local
// replica has no knowledge of this principal).
